    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="user-info">
            ...
            <div class="admin-action-info"> <span>Welcome</span>
                <h3><?php if(isset($_COOKIE['admin'])){echo "Super-Admin";}?></h3>
            </div>
        </div>
        <!-- #User Info --> 
        <!-- Menu -->
        <div class="menu" style="margin-top: -80px;">
            <ul class="list">
                ...
                <li>
                    <a href="index.php"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="children.php"><i class="zmdi zmdi-home"></i><span>Children</span></a>
                </li>
                ...
                <li>
                    <a href="healthFacility.php"><i class="material-icons">local_hospital</i><span>Health Faciity</span></a>
                </li>

                <li>
                    <a href="reports.php"><i class="zmdi zmdi-file-text"></i><span>Reports</span></a>
                </li>
                <li>
